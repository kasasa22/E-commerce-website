<template>
  <div>
    <div class="flex justify-between items-center mb-6">
      <h1 class="text-2xl font-bold text-gray-900">Yearly Report</h1>
      ...
      <div class="px-4 py-5 sm:p-6">
        ...
        <div class="grid grid-cols-1 gap-5 sm:grid-cols-3">
          ...
          <div class="bg-gray-50 px-4 py-5 rounded-lg">
            ...
            <dd class="mt-1 text-2xl font-semibold" :class="yearlyProfit >= 0 ? 'text-green-600' : 'text-red-600'">
...
const totalRevenue = computed(() => {
  return yearlySales.value.reduce((sum, sale) => sum + (sale.selling_price * sale.quantity), 0)
})
